 ...
 */
final class Version20201204111455 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE liste CHANGE theme_id theme_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE liste CHANGE theme_id theme_id INT NOT NULL');
